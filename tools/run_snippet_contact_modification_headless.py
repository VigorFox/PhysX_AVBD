#!/usr/bin/env python3
"""Run the SnippetContactModification failure-first matrix headlessly."""
...
def run_one(
    ...
    print(
        f"[CONTACT_MODIFICATION_RUN] name={spec.name} "
    ...
    for error in errors:
        print(
            f"[CONTACT_MODIFICATION_RUN_ERROR] "
...
def main() -> int:
    ...
    if not executable.is_file():
        print(
            "[CONTACT_MODIFICATION_RUNNER_ERROR] "
