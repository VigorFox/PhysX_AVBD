...
echo Building AVBD...
cl /EHsc /O2 /std:c++17 avbd_solver.cpp avbd_tests_stability.cpp avbd_tests_collision.cpp avbd_tests_joints.cpp avbd_tests_friction.cpp avbd_main.cpp /Fe:avbd_test.exe
